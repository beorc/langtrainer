...
Rails.application.config.sorcery.configure do |config|
  ...
  config.twitter.callback_url = "http://langtrainer.com/oauth/callback?provider=twitter"
  ...
  config.facebook.callback_url = "http://langtrainer.com/oauth/callback?provider=facebook"
